    ...
    return (
        <div className={styles.homepage__container}>
            ...
            <div className={styles.info__section}>
                ...
                <InfoCard title="Here's how it will work" img={one} info="I will be posting a web template everyday for the next 7-days. The person willing to learn may try to make the web in a similar manner as given in the template and mention me (@frontendj) with a hashtag (#7D7W) after completing the design. The learners can also dm me and ask for help if required."/>
                <InfoCard title="Why 7D7W?" img={two} info="This initiative is mainly taken so as to groom the designing skills and keeping in touch with the basics of web development for those who already know and also to provide opportunity to those who are willing to learn. The best way of learning is actually by doing so it is a very good opportunity to learn!"/>
                <InfoCard title="Target audience:" img={three} info="This challenge is to everyone who wants to groom their skills on web designing. And mainly to Bhutanese who are staying home due to the Nation-wide lockdown in response to the COVID19 pandemic. It is an amazing way to spend your stay at home productively by learning and grooming your skills. "/>
                </div>
